...

{
	...
	m_window = SDL_CreateWindow( "Spacewar!",
...

{
...

	{
		...
		int pchTextWidth = 0;
		int pchTextHeight = 0;
		TTF_SizeUTF8( m_MapGameFonts[ hFont ], pchText, &pchTextWidth, &pchTextHeight );

		SDL_Surface *surface = TTF_RenderUTF8_Blended_Wrapped( m_MapGameFonts[ hFont ], pchText, white, pchTextWidth );
