...
//
// Purpose: Main file for the Spacewar app
//
//=============================================================================
...
void MiniDumpFunction( unsigned int nExceptionCode, EXCEPTION_POINTERS *pException )
{
	...
	SteamAPI_SetMiniDumpComment( "Minidump comment: Spacewar.exe\n" );
...
#error	Need CreateGameEngine()
	...
	_snprintf( rgchFullPath, sizeof( rgchFullPath ), "%s/Spacewar.app/Contents/Resources/%s", rgchCWD, "steam_input_manifest.vdf" );
#else
